...
describe('Crud', () => {
    ...
    it('should insert record', async () => {
        ...
        assert.equal(true, Object.keys(table).length > 0);
    ...
    it('should get record', async () => {
        ...
        let table = await crud.get('a8988288-988a-412a-9127-e51a284e2b46');
    ...
    it('should update record', async () => {
        ...
        let table = await crud.update('a8988288-988a-412a-9127-e51a284e2b46', {
            name: 'YYYYYYYYYY'
        });
