...
class Layers {
     ...
     */
    constructor ({ layerize, name, database, cache, search, dynamoTables, schemas, validator, cacheExpireSeconds = 60 * 60 * 24 * 7, lockTimeoutMilliseconds = 30 * 1000, realTimeTransactions = false, isTransaction = false } = {}) {
