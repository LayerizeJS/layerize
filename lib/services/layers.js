                ...
                try {
                    ...
                    if (populateToCache.length > 0) {
                        ...
                        if (cachebulk.length > 0) {
                            ...
                            console.time('this.cache.mset');
                            await this.cache.mset(cachebulk, this.cacheExpireSeconds);
                            console.timeEnd('this.cache.mset');
                    ...
                    if (this.esTransaction.length > 0) {
                        ...
                        // TODO: Make the wait_for a passed in setting
                        await this.es.bulk({
                            //refresh: 'wait_for',
