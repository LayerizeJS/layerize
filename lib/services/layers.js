...
class Layers {
    ...
    async patch (table = '', key = '', data = {}, { returnRecord = false, ignoreReadOnly = [], fields = '', joins = '' } = {}) {
        ...
        try {
            ...
            data = await this._validate({ table, data: objects.clone(data), ignoreReadOnly, schema: narrowedSchema });
    ...
    async update (table = '', key = '', data = {}, { returnRecord = false, ignoreReadOnly = [], fields = '', joins = '' } = {}) {
        ...
        try {
            ...
            data = await this._validate({ table, data: objects.clone(data), ignoreReadOnly });
