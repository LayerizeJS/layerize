...
class Layers {
     ...
     */
    async insert (table = '', data = {}, { returnRecord = false, ignoreReadOnly = [], fields = '*', includes = '', createPermission = this.createPermission, events = [] } = {}) {
        ...
        try {
            ...
            let results = await this.insertMany(table, data, { returnRecords: returnRecord, ignoreReadOnly, fields, includes, createPermission, events });
     ...
     * @throws {Error} The 'data' parameter is required when doing an insert() or insertMany().
     */
    async insertMany (table = '', data = [], { returnRecords = false, ignoreReadOnly = [], fields = '*', includes = '', createPermission = this.createPermission, events = [] } = {}) {
     ...
     */
    async patch (table = '', key = '', data = {}, { returnRecord = false, ignoreReadOnly = [], fields = '*', includes = '', updatePermission = this.updatePermission, events = [] } = {}) {
     ...
     */
    async patchByFilter (table = '', filter = '', data = {}, { ignoreReadOnly = [], updatePermission = this.updatePermission, events = [] } = {}) {
     ...
     */
    async patchMany (table = '', data = [], { returnRecords = false, ignoreReadOnly = [], fields = '*', includes = '', updatePermission = this.updatePermission, events = [] } = {}) {
     ...
     * @returns {Promise<success>} If layer IS NOT a transaction and returnRecord is 'false', then it will return a success object
     */
    async update (table = '', data = {}, { returnRecord = false, ignoreReadOnly = [], fields = '*', includes = '', updatePermission = this.updatePermission, events = [] } = {}) {
    ...
    async updateMany (table = '', data = [], { returnRecords = false, ignoreReadOnly = [], fields = '*', includes = '', updatePermission = this.updatePermission } = {}) {
        ...
        try {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                await this._validate({ table, data: item });
        ...
        try {
            ...
            try {
                ...
                if (Object.keys(schema).length) {
                    ...
                    schema = this.validator.getSchema(table);
