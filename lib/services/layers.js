...
class Layers {
    ...
    async delete (table = '', key = '') {
        ...
        try {
            ...
            return await this.deleteMany(table, [ key ]);
     ...
     * @returns {Promise<success>} If layer IS NOT a transaction and returnRecord is 'false', then it will return a success object
     */
    async update (table = '', data = {}, { returnRecord = false, ignoreReadOnly = [], fields = '', includes = '' } = {}) {
     ...
     * @param {string} [options.table=''] - name of the table
     * @param {string|array|object} [options.filter=''] - layerize filter syntax
     * @returns {knex|object} The extended passed in statement
     ...
     * @returns {string} db sql where statement
     */
    _dbFilter (objFilter = {}) {
