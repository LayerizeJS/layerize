...
class Layers {
    ...
    async get (table = '', key = '', { fields = '', joins = '' } = {}) {
        ...
        try {
            ...
            if (result === null) {
                ...
                let results = requestFields(await statement, fields);
    ...
    /**
     * Patches a single records into the data layer
     * @param {String} table
     * @param {String} key
     * @param {Object} data
     * @param {Object} options { returnRecord = false, ignoreReadOnly = [] }
    ...
    /**
     * Patches a single or mulitple records from the data layer that is meets the filter restraint
     * @param {String} table
     * @param {String} filter
     * @param {Object} data
    ...
    /**
     * Updates a single records into the data layer
     * @param {String} table
     * @param {String} key
     * @param {Object} data
     * @param {Object} options { returnRecord = false, ignoreReadOnly = [] }
