    ...
    async _attachToObject ({ table = '', includeId = '', results = [] } = {}) {
        ...
        try {
            ...
            if (results.length > 0) {
                ...
                property = schema.includes[includeId].property;
                attachTable = schema.includes[includeId].table;
                attachKey = schema.includes[includeId].column;
                ...
                for (let x = 0; x < items.length; x++) {
                    ...
                    for (let j = 0; j < locations.length; j++) {
                        ...
                        results[location][attachTable] = item;
    ...
    async _includes ({ table = '', results = [], includes = '' } = {}) {
        ...
        try {
            ...
            for (let i = 0; i < includes.length; i++) {
                ...
                switch (schema.includes[includeId].relationship) {
