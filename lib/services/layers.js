...
class Layers {
    ...
    async search (table = '', {
        ...
        try {
            ...
            if (schema.esEnabled && (type === 'auto' || type === 'es')) {
        ...
        try {
            ...
            if (objFilter.native.active) {
                ...
                if (isEsStatement) {
                    ...
                    statement.body.query = objFilter.native.query;

                    if (Object.keys(statement.body.query).length === 0) {

                        statement.body.query = {
                            match_all: {}
                        };
        ...
        if (typeof filter === 'object' && !Array.isArray(filter)) {
            ...
            if (typeof filter.native === 'boolean' && filter.native === true && (typeof filter.where === 'string' || typeof filter.query === 'object')) {
                ...
                if (typeof filter.where === 'string') {
                    ...
                    objFilter.native.query = filter.query;
    ...
    __buildFilter ({ schema = {}, objFilter = {}, filter = '' } = {}) {
        ...
        try {
            ...
            throw this.error.handle({ error, caller: '__buildDbFilter' });
