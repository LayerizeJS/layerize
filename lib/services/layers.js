...
class Layers {
    ...
    async get (table = '', key = '', { fields = '', joins = '', forUpdate = false } = {}) {
        ...
        try {
            ...
            let results = await this.getMany(table, keys, { fields, joins, forUpdate });
     ...
     */
    async getMany (table = '', keys = [], { fields = '', joins = '', forUpdate = false } = {}) {

        this.debug('getMany()', { joins });
     ...
     * @returns {Promise} - resolves: { success: true } | rejects: Error
     */
    async insertMany (table = '', data = [], { returnRecords = false, ignoreReadOnly = [], fields = '' } = {}) {
        ...
        try {
            ...
            if (this.isTransaction) {
                ...
                return await this.__nonTransactionESCacheProcessing({ table, schema, statement, returnRecords, fields });
     ...
     * @returns {Promise} - resolves: { success: true } | rejects: Error
     */
    async patch (table = '', key = '', data = {}, { returnRecord = false, ignoreReadOnly = [], fields = '' } = {}) {
        ...
        try {
            ...
            if (this.isTransaction) {
                ...
                let results = await this.__nonTransactionESCacheProcessing({ type: 'update', table, keys: [ key ], schema, statement, returnRecords: returnRecord, fields });
                return results[0];
     ...
     * @returns {Promise} - resolves: { success: true } | rejects: Error
     */
    async patchMany (table = '', data = [], { returnRecords = false, ignoreReadOnly = [], fields = '' } = {}) {
        ...
        try {
            ...
            if (this.isTransaction) {
                ...
                return await this.__nonTransactionESCacheProcessing({ type: 'update', table, keys, schema, statement: statements, returnRecords, fields });
     ...
     * @returns {Promise} - resolves: { success: true } | rejects: Error
     */
    async update (table = '', key = '', data = {}, { returnRecord = false, ignoreReadOnly = [], fields = '' } = {}) {
     ...
     * @returns {Promise} - resolves: { success: true } | rejects: Error
     */
    async updateMany (table = '', data = [], { returnRecords = false, ignoreReadOnly = [], fields = '' } = {}) {
    ...
    async __nonTransactionESCacheProcessing ({ type = 'insert', table, keys = [], schema, statement, returnRecords, fields } = {}) {
        ...
        try {
            ...
            if (schema.esEnabled || returnRecords || (type === 'update' && keys.length === 0)) {
                ...
                if (returnRecords === false) {
                    ...
                    result = requestFields(items, fields);
