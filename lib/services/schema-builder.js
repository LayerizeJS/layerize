...
const { parseRefs, allowedProperties } = layerizeSchema;
...
class SchemaBuilder {
     ...
     * @param {array} schemaFiles - a file pattern to schema locations
     ...
     */
    async load (schemaFiles = [], { parseWithLayerize = true } = {}) {
        ...
        try {
            ...
            for (let i = 0; i < schemaFiles.length; i++) {
                ...
                let schema = schemaFiles[i];

                if (typeof schema === 'undefined') {

                    this.debug(' -- schema is undefined.');

                } else {

                    if (typeof schema.version !== 'undefined') {

                        this.debug(' -- Found config file.');
                        ...
                        schema = this.__preprocessRawSchema(schema);
            ...
            if (arySchemas.length > 0) {
                ...
                this.debug(` -- Loading ${arySchemas.length} schema files.`);
    ...
    layerize ({ schemas = {} } = {}) {
        ...
        try {
            ...
            for (let i = 0; i < schemas.raw.length; i++) {
                ...
                for (let x = 0; x < propertyNames.length; x++) {
                    ...
                    if (elasticSearch.enabled) {
                        ...
                        if (typeof property.elasticSearch === 'undefined' || (typeof property.elasticSearch !== 'undefined' && (typeof property.elasticSearch.enabled === 'undefined' || property.elasticSearch.enabled === true))) {
                            ...
                            if (typeof property.default !== 'undefined' && typeof property.default !== 'object') {
                ...
                table.allowedProperties = allowedProperties({ schema: table, validator: this.validator });
                        ...
                        switch (property.type) {
                            ...
                            case 'array':
                                if (typeof property.default !== 'undefined') {
                                    ...
                                    recursiveBaseObject[propertyName] = property.default;

                                } else {

                                    recursiveBaseObject[propertyName] = property.nullable ? null : [];
    ...
    /**
     * translate JSON schema property types to ElasticSearch.
     * @param {object} schema - a raw schema
     * @param {boolean} isArray - is the parent schema an array
     * @returns {object} elasticsearch body object
     */
    __preprocessRawSchema (schema, isArray = false) {

        this.debug('_preprocessRawSchema()');
        try {

            let properties = schema.properties;

            if (isArray && typeof schema.items !== 'undefined') {
                ...
                for (let x = 0; x < propertyNames.length; x++) {
                    ...
                    switch (property.type) {
                        ...
                        case 'array':
                            ...
                            property = this.__preprocessRawSchema(property, true);

                            break;

                        case 'integer':

                            if (typeof property.default === 'undefined' && !property.serial) {
                        ...
                        case 'object':
                            ...
                            property = this.__preprocessRawSchema(property);
                        ...
                        default:
                            ...
                            if (typeof property.default === 'undefined' && typeof property.format === 'undefined') {
                            ...
                            if (property.nullable === true && property.type === 'string') {
            ...
            } else if (typeof schema.allOf !== 'undefined' && Array.isArray(schema.allOf)) {

                for (let i = 0; i < schema.allOf.length; i++) {

                    this.__preprocessRawSchema(schema.allOf[i]);
            ...
            throw this.error.handle({ error, caller: '_preprocessRawSchema' });
