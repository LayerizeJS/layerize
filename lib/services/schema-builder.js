...
class SchemaBuilder {
    ...
    layerize ({ schemas = {} } = {}) {
        ...
        try {
            ...
            for (let i = 0; i < schemas.raw.length; i++) {
                ...
                table.allowedProperties = this.__allowedProperties(table);
     ...
     * @returns {object} elasticsearch body object
     */
    __allowedProperties (table) {

        this.debug('__allowedProperties()');
        ...
        try {
                            ...
                            switch (property.type) {
                                ...
                                case 'array':
                                    ...
                                    if (parentIsArray) {
                                        ...
                                        if (typeof items !== 'undefined' && typeof items.$ref !== 'undefined') {

                                            items = this.validator.getSchema(items.$ref);
            ...
            allowedProperties.root = recursive(table.properties);

            return allowedProperties;

        } catch (error) {

            throw this.error.handle({ error, caller: '__allowedProperties' });
        ...
        try {
            ...
            if (typeof schema.properties !== 'undefined') {
                ...
                for (let x = 0; x < propertyNames.length; x++) {
                    ...
                    let property = schema.properties[propertyNames[x]];
