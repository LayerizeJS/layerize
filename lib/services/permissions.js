...
class Permissions {
     ...
     */
    async authorizedProperties (authorization = {}, data = {}, currentRecord = {}) {
            ...
            if (typeof data[propertyKey] !== 'undefined') {
                ...
                if (!propertyAllowed) {
                    ...
                    if (property.properties.length > 0) {
                        ...
                        data = this.__processProperties(property.properties, data[propertyKey], currentRecord[propertyKey], false);
