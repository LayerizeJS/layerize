...
class Base {
     ...
     */
    constructor ({ layerize, schemaName = 'public', table = '', debug = defaultDebug, permissions = {}, user_id = '' } = {}) {
         ...
         * @member {Layers}
         * */
        this.layers = this.layerize.layers({ schemaName: this.schemaName, permissions, user_id });
        ...
        /**
         * Holds permission array
         * @member {array}
         * */
        this.permissionRole = permissions.role || [];
