                ...
                for (let i = 0; i < properties.length; i++) {
                    ...
                    if (property === '$ref') {
                        ...
                        if (typeof refObj.schema !== 'undefined' && typeof refObj.refs !== 'undefined' && typeof refObj.refVal !== 'undefined') {
                            ...
                            newObj = scanProperties(refObj.schema || {}, refObj.refs || {}, refObj.refVal || [], parsedSchema.$id || '', depth);

                        } else {

                            newObj = scanProperties(refObj || {}, refs, refVal, id, depth);
                    ...
                    if (typeof value === 'object') {
                        ...
                        if (Array.isArray(value)) {
                            ...
                            for (let x = 0; x < value.length; x++) {
                                ...
                                value[x] = scanProperties(value[x], refs, refVal, id, depth);

                            }

                        } else {

                            value = scanProperties(value, refs, refVal, id, depth);
