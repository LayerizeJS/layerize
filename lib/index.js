...
class Layerize {
     ...
     */
    constructor ({ schemas = '', keywords = '', formats = '', cacheExpireSeconds = 60 * 60 * 24 * 7, realTimeTransactions = false, layerizeSchemaName = 'layerize', coerceTypes = false, removeAdditionalProperties = true, auditLogs = true } = {}) {
        ...
        this.permissions = {
            ...
            definitionGlob: '',
            definitions: {},
            validator: new JsonValidator({ coerceTypes: this.coerceTypes, removeAdditional: this.removeAdditionalProperties }).validator,
            schemas: {},
            connector: null,
            getRole: null
        };
     ...
     */
    layers ({ schemaName, schemas = this.schemas, realTimeTransactions = this.realTimeTransactions, layerizeCore = false, validator = this.validator, permissions = {} } = {}) {
