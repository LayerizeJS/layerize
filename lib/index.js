...
const { Base, Crud, Layers, SchemaBuilder, Schemas, Tables } = require('./services');
...
class Layerize {
    ...
    layers ({ schemaName, schemas = this.schemas, realTimeTransactions = this.realTimeTransactions, layerizeCore = false } = {}) {
        ...
        try {
            ...
            for (let i = 0; i < tables.length; i++) {
                ...
                if (typeof objExistingTables[table.name] === 'undefined') {
                    ...
                    tableRecord.schema = table;
                    tableRecord.version = schemas.version;
                    tableRecord.hash = table.hash;
